  ...
  return (
    <nav className="navbar navbar-expand-lg navbar-dark bg-primary shadow-lg rounded-bottom mb-4">
      <div className="container-fluid">
        <Link className="navbar-brand mx-5" to="/">Dynamic Routing Demo</Link>
          ...
          <ul className="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li className="nav-item dropdown">
              ...
              <ul className="dropdown-menu" aria-labelledby="navbarDropdown">
                <li><Link className="dropdown-item" to="/user/123">Basic User </Link></li>
                <li><Link className="dropdown-item" to="/user/456/Alice">Multi-Param User</Link></li>
                <li><Link className="dropdown-item" to="/user-optional/123">Optional Param User (ID: 123)</Link></li>
            ...
            <li className="nav-item">
              <Link className="nav-link" to="/user/999/posts">Nested Route </Link>
            </li>
            <li className="nav-item">
              <Link className="nav-link" to="/user-data/202">Fetch User Data </Link>
            </li>
            <li className="nav-item">
